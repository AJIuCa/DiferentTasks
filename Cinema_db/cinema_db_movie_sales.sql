...
CREATE TABLE `movie_sales` (
  ...
  `sale` decimal(10,2) unsigned DEFAULT NULL,
...
LOCK TABLES `movie_sales` WRITE;
/*!40000 ALTER TABLE `movie_sales` DISABLE KEYS */;
INSERT INTO `movie_sales` VALUES (1,555.00,6),(2,130.00,2),(3,337.50,5),(4,528.00,7),(5,72.00,1),(6,0.00,0),(7,0.00,0);
/*!40000 ALTER TABLE `movie_sales` ENABLE KEYS */;
UNLOCK TABLES;
